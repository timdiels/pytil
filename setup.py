...
setup(
    **{   'author': 'Tim Diels',
    ...
    'long_description': 'Chicken Turtle Util (CTU) provides an API of various Python utility\n'
                        ...
                        '-----------------------\n'
                        '\n'
                        '-  Added cli.ConfigurationMixin: application context mixin for loading a\n'
                        '   configuration\n'
                        '-  Added configuration.ConfigurationLoader: loads a single configuration\n'
                        ...
                        '\n'
                        'If extending a module from another project, e.g. pandas, use the same\n'
                        'name as the module. While a ``from pandas import *`` would allow the\n'
                        'user to access functions of the real pandas module through the extended\n'
                        'module, we have no control over additions to the real pandas, which\n'
                        "could lead to name clashes later on, so don't.\n"
                        '\n'
                        ...
                        'Exception classes, but function for a set of related functions operating\n'
                        'on functions.\n'
                        '\n'
                        'API implementation\n'
                        '~~~~~~~~~~~~~~~~~~\n'
                        ...
                        'are exported, but help or Sphinx documentation will not include them and\n'
                        'thus a user should realise they should not be used. E.g.\n'
                        '``import numpy as np`` in module.py can be accessed with module.np, but\n'
