...
'''
Test chicken_turtle_util.application
'''

from chicken_turtle_util import cli, application as app
...
class TestMixins(object):
    ...
    def test_basics(self):
        ...
        class MyAppContext(app.BasicsMixin(version), app.Context):
            pass
    ...
    def test_database(self, mocker):
        ...
        class MyAppContext(app.DatabaseMixin(Database), app.Context):
            pass
    ...
    def test_configuration(self, mocker, tmpdir):
        ...
        class MyAppContext(app.ConfigurationMixin(create_configuration, help_message), app.Context):
            pass
    ...
    def test_configurations(self, mocker, tmpdir):
        ...
        class MyAppContext(app.ConfigurationsMixin(help_messages), app.Context):
            pass
    ...
    class TestOutputDirectory(object):
        ...
        def main(self, output_dir):
            class MyAppContext(app.OutputDirectoryMixin, app.Context):
                pass
